Module.register("MMM-forecast-io", {
  ...
  defaults: {
    ...
    updateInterval: 5 * 60 * 1000, // cada 5 minutos
    animationSpeed: 1000,
    initialLoadDelay: 0, // 0 segundos de retraso
    retryDelay: 2500,
    tempDecimalPlaces: 0, // temperaturas redondeadas a este número de decimales
    geoLocationOptions: {
    ...
    longitude: null,
    showForecast: true,
    maxDaysForecast: 7,   // número máximo de días para mostrar en forecast
    ...
    iconTable: {
      'día claro':           'wi-día-claro☀',
      'Noche clara':         'wi-Noche-clara☁',
      'lluvia':                'wi-lluvia☂',
      'nieve':                'wi-nieve☃',
      'aguanieve':               'wi-Aguanieve☄',
      'viento':                'wi-viento♒',
      'niebla':                 'wi-niebla⚠ ',
      'nublado':              'wi-nublado',
      'día-parcialmente-nublado':   'wi-parcial-nublado☾',
      'parcialmente-nublado-noche': 'wi-noche-nublada',
      'granizo':                'wi-granizo☔',
      'tormenta':        'wi-tormenta⚡',
      'tornado':             'wi-tornado☹'
    },
  ...
  getDom: function() {
    ...
    if (this.config.apiKey === "") {
      wrapper.innerHTML = "Por favor, configure la correcta forcast.io <i>apiKey</i> en la configuración para el módulo: " + this.name + ".";
      wrapper.className = "dimmed light small";
      return wrapper;
    }

    if (this.geoLocationLookupFailed) {
      wrapper.innerHTML = "La búsqueda de Geolocaiton falló, establezca <i>latitude</i> y <i>longitude</i> configure en el modulo: " + this.name + ".";
      wrapper.className = "dimmed light small";
      return wrapper;
    }
